...
@Module({
  imports: [
    TypeOrmModule.forFeature([Group, GroupParticipant, GroupGameSettings, GroupEvaluation, GroupParticipantPosition, GroupReferee, GroupFavorite, MatchReview, GroupProvisionalFacility]),
    NotificationsModule,
    UsersModule,
    FacilitiesModule,
  ],
