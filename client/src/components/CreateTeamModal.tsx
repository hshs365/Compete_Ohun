...
const CreateTeamModal: React.FC<CreateTeamModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await showError(err?.message || '용병 크루 생성에 실패했습니다.', '용병 크루 생성 실패');
    } finally {
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
              용병 크루 소재지 <span className="text-[var(--color-text-secondary)]">(필수)</span>
            </label>
            <select
              value={region}
          ...
          {/* 용병 크루 로고 */}
          <div>
            <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">용병 크루 로고</label>
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
              용병 크루명 <span className="text-[var(--color-text-secondary)]">(필수)</span>
            </label>
            <input
              type="text"
              value={teamName}
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">용병 크루 소개</label>
            <textarea
              value={description}
